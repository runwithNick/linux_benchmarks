...
# UNCOMMENT THIS IF INSTALLING TO EXPANSE
# ADDING PORTS TO FIREWALL FOR 10 minutes
# printf "\nAdding port 19765 for 10 minutes ... "
# sudo firewall-cmd --add-port=19765/tcp --timeout=10m
# printf "\nAdding port 19865 for 10 minutes ... "
# sudo firewall-cmd --add-port=19865/tcp --timeout=10m
